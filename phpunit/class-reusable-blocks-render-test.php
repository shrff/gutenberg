<?php
/**
 * Saved block rendering tests.
 *
 * @package Gutenberg
 */

/**
 * Tests saved block rendering.
 */
class Saved_Blocks_Render_Test extends WP_UnitTestCase {
	/**
	 * Fake user ID.
	 *
	 * @var int
	...
	/**
	 * Test rendering of a saved block.
	 */
	...
	/**
	 * Test rendering of a saved block when 'ref' is missing, which should fail by
	...
	/**
	 * Test rendering of a saved block when 'ref' points to wrong post type, which
