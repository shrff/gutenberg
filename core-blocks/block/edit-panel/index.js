...
class SavedBlockEditPanel extends Component {
	constructor() {
		super( ...arguments );
			...
			<Fragment>
				{ ( ! isEditing && ! isSaving ) && (
					<div className="saved-block-edit-panel">
						<b className="saved-block-edit-panel__info">
							{ title }
						</b>
						<Button
							ref={ this.editButton }
							isLarge
							className="saved-block-edit-panel__button"
							onClick={ onEdit }
						>
							{ __( 'Edit' ) }
						</Button>
				...
				{ ( isEditing || isSaving ) && (
					<form className="saved-block-edit-panel" onSubmit={ this.handleFormSubmit }>
						<label
							htmlFor={ `saved-block-edit-panel__title-${ instanceId }` }
							className="saved-block-edit-panel__label"
						>
							{ __( 'Name:' ) }
						</label>
						<input
							...
							type="text"
							disabled={ isSaving }
							className="saved-block-edit-panel__title"
							value={ title }
							onChange={ this.handleTitleChange }
							onKeyDown={ this.handleTitleKeyDown }
							id={ `saved-block-edit-panel__title-${ instanceId }` }
						/>
						<Button
							type="submit"
							isPrimary
...
export default withInstanceId( SavedBlockEditPanel );
